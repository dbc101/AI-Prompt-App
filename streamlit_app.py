        ...
        <div class="ds-workflow" aria-label="Demo prep workflow">
            ...
            <a class="ds-workflow-step" href="#prompt-validation">
                ...
                <div>
                    ...
                    <small>Check the agent response</small>
                </div>
            </a>
        </div>
        """,
...
def _render_gemini_mode_steps() -> None:
    st.markdown(
        ...
        <div class="ds-steps ds-steps-compact">
            Copy the brief into Gemini or another approved LLM workspace, then run the Demo-Readiness Check on the AI Agent response.
        </div>
        """,
        unsafe_allow_html=True,
    )
...
def _render_prompt_readiness(context: dict[str, Any], generated_prompt: str, missing_fields: list[str]) -> None:
    ...
    st.markdown(
        ...
        <div class="ds-readiness-panel">
            ...
            {issue_block}
            <div class="ds-readiness-note">This does not replace the Demo-Readiness Check; it confirms the optimized prompt has the core ingredients before you run it.</div>
        </div>
        """,
        unsafe_allow_html=True,
    )
