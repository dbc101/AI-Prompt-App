...
- Remove any old customer name from the source prompt and replace old industry, LOB, use case, primary agreement type, objective, perspective, or prompt destination with the context above.
