...
- Applies audience-aware length limits: 150 words for leadership/executive summaries, 180 words for chat or Agent Studio demos, no prose word limit for Workflow-only structured output, and 300 words for internal analysis/debugging.
