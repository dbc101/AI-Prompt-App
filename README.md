...
- Applies audience-aware length limits: 175 words for leadership/executive summaries, 220 words for AI Chat demos, 250 words for Agent Studio demos, no prose word limit for Workflow-only structured output, and 300 words for internal analysis/debugging.
