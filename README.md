...
4. Click **Generate Optimized Prompt** or **Create New Prompt Brief**.
...
9. Paste the AI Agent output into **Demo-Readiness Check** and review the result, issue list, quality scores, prompt improvements, optional prompt tune-up, and retest checklist.
...
**Create New** skips the Prompt Library and creates a copy-ready new prompt brief from the intake context. The app does not call Gemini directly or store Gemini credentials. SCs copy the brief, open Gemini or another approved enterprise LLM workspace, paste it into a new chat, then run the generated prompt and check the sample output in Demo-Readiness Check.
